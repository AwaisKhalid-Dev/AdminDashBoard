...
import payment from '../../assets/img/logos/mastercard.png'
export default function index() {
  return (
    <>
      <nav className="navbar   navbar-main navbar-expand-lg px-0 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
